...
public class Message {
    ...
    public static final String ADDING_NO_EXISTING_COURSE_TO_STUDENT = "Course that you are trying to add to student is not exist!";
    ...
    public static final String REMOVING_EXISTING_COURSE_TO_STUDENT = "Course that you are trying to remove from student is not exist!";
    ...
    public static final String ADDING_NO_EXISTING_COURSE_TO_TEACHER = "Course that you are trying to add to teacher is not exist!";
    public static final String REMOVING_EXISTING_COURSE_TO_TEACHER = "Course that you are trying to remove from teacher is not exist!";
}
